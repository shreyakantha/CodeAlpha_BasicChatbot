...
This project implements a simple rule-based chatbot using Python. The chatbot interacts with users through predefined text inputs such as greetings, common questions, and exit commands, and responds with fixed and appropriate replies.  
...
---
## 🎯 Goal
Build a basic rule-based chatbot that accepts user input such as greetings and simple questions, responds with predefined messages, and exits gracefully when the user types a termination command.
...
- Maintains a simple conversational flow using follow-up responses
...
## 🛠 Tech Stack
- **Language :** Python 3.x
- **Library Used :** `string` for punctuation handling
